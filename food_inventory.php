...
$inventory_query = $conn->query("SELECT fi.*, u.name as user_name FROM food_inventory fi JOIN users u ON fi.user_id = u.user_id");
$inventory = $inventory_query->fetch_all(MYSQLI_ASSOC);
?>
        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="view_food.php?id=<?= $item['food_id'] ?>" class="btn-action btn-view">View</a>
                        <a href="edit_food.php?id=<?= $item['food_id'] ?>" class="btn-action btn-edit">Edit</a>
                        <a href="delete_food.php?id=<?= $item['food_id'] ?>" class="btn-action btn-delete" onclick="return confirm('Are you sure you want to delete this item?')">Delete</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
