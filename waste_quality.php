...
// Fetch waste quality assessments with waste log info
$quality_query = $conn->query("SELECT wq.*, wl.waste_type 
                              FROM waste_quality wq 
                              JOIN waste_log wl ON wq.waste_id = wl.waste_id");
$assessments = $quality_query->fetch_all(MYSQLI_ASSOC);
?>
...
<head>
  <meta charset="UTF-8">
  <title>Waste Quality - FoodResQ</title>
...
<body>
    ...
    <div class="main-content">
        <div class="page-title">
            <h1>Waste Quality Assessments</h1>
        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= htmlspecialchars($assessment['waste_type']) ?></td>
                    <td><?= $assessment['assessment_date'] ?></td>
                    <td><?= $assessment['quality_grade'] ?></td>
                    <td><?= htmlspecialchars($assessment['remarks']) ?></td>
                    <td>
                        <a href="view_quality.php?id=<?= $assessment['assessment_id'] ?>" class="btn-action btn-view">View</a>
                        <a href="edit_quality.php?id=<?= $assessment['assessment_id'] ?>" class="btn-action btn-edit">Edit</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
